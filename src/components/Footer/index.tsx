            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Mail className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-400" />
                  <a
                    href="mailto:vansandutesforhire@gmail.com"
                    className="transition-smooth text-gray-400 hover:text-white"
                  >
                    vansandutesforhire@gmail.com
                  </a>
                </li>
                <li className="flex items-start">
                  <Phone className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-400" />
                  <a
                ...
                <li className="flex items-start">
                  <MapPin className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-400" />
              ...
              <form className="space-y-3">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-gray-700 bg-gray-800 px-4 py-2 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    required
                  />
                  {/* Submit Button */}
                  <button
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  Designed and Developed © 2025 All Rights Reserved{" "}
                  <Link
                    href="https://praveenpremasinghe-me.netlify.app/"
