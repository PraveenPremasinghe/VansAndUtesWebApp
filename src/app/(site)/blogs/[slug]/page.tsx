...
import { getAllBlogs, getBlogBySlug } from "@/data/mockBlogs";
...
export async function generateMetadata({ params }: Props) {
  ...
  const siteName = "Vans & Utes";

  if (post) {
    return {
      title: `${post.title || "Blog Post"} | ${siteName}`,
      description: post.excerpt || "Read our latest blog post about vehicle rentals and travel tips.",
      author: post.author || "Vans & Utes Team",
      robots: {
        index: true,
        follow: true,
        nocache: true,
    ...
    return {
      title: "Blog Post Not Found | Vans & Utes",
...
export default function Post({ params }: Props) {
  ...
  // Since this is a server component, we need to handle the async params
  // For now, we'll use a workaround by making this component async
  return <PostContent paramsPromise={slugPromise} />;
}

async function PostContent({ paramsPromise }: { paramsPromise: Promise<{ slug: string }> }) {
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              ...
              >
                <Image
                  src={post.coverImage || "/images/blog/110.jpg"}
                  ...
                  <div className="flex flex-wrap items-center p-4 pb-4 sm:p-8">
                    <div className="mb-4 mr-5 flex items-center md:mr-10">
                      <div className="mr-4 h-10 w-10 overflow-hidden rounded-full">
                        <Image
                          src={post.authorImage || "/images/blog/author-01.png"}
                      ...
                      {blogs
                        ...
                        .map((blog, i) => (
                          <PopularArticle
                            ...
                            name={blog?.author || "Vans & Utes Team"}
                            slug={blog?.slug}
                          />
                        ))}
                    </div>
